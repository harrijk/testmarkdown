...
| Component | Commit Level | 
| :--- | :--- | 
| fabric | 6b6bfcfbd1e798a8a08fa9c3bf4dc0ff766a6b87 |
| fabric-sdk-node | f13f4b42e7155ec0dc3d7485b202bb6a6ca73aed |
| fabric-ca | f5216c35e8ce46e8c04842ec529d2c1974b95894 |
| PTE | current |

## Future items:

- PTE needs to support any number of organizations in a channel.  Currently, PTE supports two organizations per channel (FAB-3809).
...
- Endorsement policy is currently not supported.
...
- cd fabric
- git checkout 6b6bfcfbd1e798a8a08fa9c3bf4dc0ff766a6b87
- make docker
- git checkout master
- cd ..
